# NS BD Shop - ল্যান্ডিং পেজ কাস্টমাইজেশন গাইড
...
ওয়েবসাইটের বিভিন্ন জায়গায় অফার প্রাইস ও রেগুলার প্রাইস দেওয়া আছে। এগুলো পরিবর্তন করতে [index.html](file:///f:/Website%20&%20SaaS/Smart%20Tools%20BD/index.html) ফাইলটি কোড এডিটরে ওপেন করে নিচের অংশগুলো পরিবর্তন করুন:
...
## ৪. ফেসবুক পিক্সেল সেটআপ (Facebook Pixel Setup)
ফেসবুক পেইড ক্যাম্পেইনের ট্র্যাকিং পিক্সেল অলরেডি আপনার ল্যান্ডিং পেজে প্রি-ইন্সটল করা আছে। আপনাকে শুধু আপনার নিজস্ব Pixel ID টি কোডে বসিয়ে দিতে হবে।

* **ধাপ ১: পিক্সেল আইডি পরিবর্তন (index.html):**
  [index.html](file:///f:/Website%20&%20SaaS/Smart%20Tools%20BD/index.html) ফাইলটি ওপেন করুন (লাইন ৬২ থেকে ৭৬ এর মধ্যে)। সেখানে নিচের কোডটি দেখতে পাবেন:
  ```html
  fbq('init', 'YOUR_PIXEL_ID');
  ...
  src="https://www.facebook.com/tr?id=YOUR_PIXEL_ID&ev=PageView&noscript=1"
  ```
  এখানে **`YOUR_PIXEL_ID`** লেখা দুটি জায়গা পরিবর্তন করে আপনার ফেসবুক ইভেন্ট ম্যানেজার থেকে পাওয়া ১৫ সংখ্যার পিক্সেল আইডিটি বসিয়ে দিন। (যেমন: `987654321098765`)।

* **ধাপ ২: অর্ডার সাকসেস ট্র্যাকিং (Purchase Event):**
  কাস্টমার অর্ডার ফর্মটি সফলভাবে পূরণ করলে স্বয়ংক্রিয়ভাবে একটি **Purchase** ইভেন্ট ফায়ার হবে, যা ফেসবুকে আপনার কনভার্সন ট্র্যাক করবে। এর জন্য জাভাস্ক্রিপ্ট কোড [app.js](file:///f:/Website%20&%20SaaS/Smart%20Tools%20BD/app.js) ফাইলে অলরেডি সংযুক্ত করা আছে।
...
1. আপনার ল্যান্ডিং পেজের [app.js](file:///f:/Website%20&%20SaaS/Smart%20Tools%20BD/app.js) ফাইলটি ওপেন করুন।
2. লাইন ১৫০-এর দিকে `GOOGLE_SCRIPT_URL` এর ভেতরে আপনার কপি করা URL-টি পেস্ট করুন:
   ```javascript
